...
# for compatibility with pytorch 0.3
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, embedding_size=64, hypersphere=False):
    ...
    if pretrained:
        ...
        for k in loaded_state_dict:
            if k in state:
                state[k] = loaded_state_dict[k]
        model.load_state_dict(state)
        print('ResNet pretrained on ImageNet loaded!')
